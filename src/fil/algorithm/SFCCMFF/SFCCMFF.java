...
import fil.algorithm.SFCCMRESCE.MappingServer;
...
public class SFCCMFF  {
	...
	public SFCCMFF() { // default constructor
...
//			listVNFmigration.add(numVNFMigration);
		...
		try {
			write_double("./PlotSFCCM-FF/totalPiAcceptance.txt",totalPiAcceptance);
			write_double("./PlotSFCCM-FF/capacity.txt",capacity);
			write_double("./PlotSFCCM-FF/capacityEdge.txt",capacityEdge);
			write_double("./PlotSFCCM-FF/capacityCloud.txt",capacityCloud);
			write_double("./PlotSFCCM-FF/averageBWUsage.txt",averageBWUsage);
			write_double("./PlotSFCCM-FF/totalPowerSystemConsolidation.txt",totalPowerSystemConsolidation);
			write_double("./PlotSFCCM-FF/listLinkUsage.txt",listLinkUsage);
			write_double("./PlotSFCCM-FF/cpuEdgeUsagePerSFC.txt",cpuEdgeUsagePerSFC);
			write_double("./PlotSFCCM-FF/cpuServerUsagePerSFC.txt",cpuServerUsagePerSFC);
			write_double("./PlotSFCCM-FF/serverUtilization.txt",serverUtilization);
			write_integer("./PlotSFCCM-FF/NumVNFMigration.txt",listVNFmigration);
			write_integer("./PlotSFCCM-FF/totalChainLeave.txt",totalChainLeave);
			write_integer("./PlotSFCCM-FF/listServerUsed.txt",listServerUsed);
			write_integer("./PlotSFCCM-FF/requestRandom.txt",requestRandomReceive);
			write_integer("./PlotSFCCM-FF/totalDecOffload.txt",totalDecOffload);
			write_integer("./PlotSFCCM-FF/totalDenOffload.txt",totalDenOffload);
			write_double("./PlotSFCCM-FF/totalPowerSystem.txt",totalPowerSystem);
			write_double("./PlotSFCCM-FF/totalPowerSystemPerSFC.txt",totalPowerPerSFC);
			write_double("./PlotSFCCM-FF/totalLoadEdge.txt",totalLoadEdge);
			write_double("./PlotSFCCM-FF/totalBwEdge.txt",totalBwEdge);
			write_double("./PlotSFCCM-FF/totalChainAcceptance.txt",totalChainAcceptance);
			write_integer("./PlotSFCCM-FF/totalChainSystem.txt",totalChainSystem);
			write_integer("./PlotSFCCM-FF/totalChainActive.txt",totalChainActive);
			write_integer("./PlotSFCCM-FF/totalChainReject.txt",totalChainReject);
			write_excel("./PlotSFCCM-FF/requestEachPiDetail.xlsx",listRequestForEachPi);
			write_excel("./PlotSFCCM-FF/leaveEachPiDetail.xlsx",listLeaveForEachPi);
			write_excel("./PlotSFCCM-FF/offSerEachPi01.xlsx",listOffForEachPi);
			write_excel_double("./PlotSFCCM-FF/cpuEachPi01.xlsx",listCPUForEachPi);
			write_excel_double("./PlotSFCCM-FF/bwEachPi01.xlsx",listBWForEachPi);
