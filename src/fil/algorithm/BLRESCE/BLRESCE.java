...
//			listVNFmigration.add(numVNFMigration);
		...
		try {
			write_double("./PlotBL-RESCE/totalPiAcceptance.txt",totalPiAcceptance);
			write_double("./PlotBL-RESCE/capacity.txt",capacity);
			write_double("./PlotBL-RESCE/capacityEdge.txt",capacityEdge);
			write_double("./PlotBL-RESCE/capacityCloud.txt",capacityCloud);
			write_double("./PlotBL-RESCE/averageBWUsage.txt",averageBWUsage);
			write_double("./PlotBL-RESCE/totalPowerSystemConsolidation.txt",totalPowerSystemConsolidation);
			write_double("./PlotBL-RESCE/listLinkUsage.txt",listLinkUsage);
			write_double("./PlotBL-RESCE/cpuEdgeUsagePerSFC.txt",cpuEdgeUsagePerSFC);
			write_double("./PlotBL-RESCE/cpuServerUsagePerSFC.txt",cpuServerUsagePerSFC);
			write_double("./PlotBL-RESCE/serverUtilization.txt",serverUtilization);
			write_integer("./PlotBL-RESCE/NumVNFMigration.txt",listVNFmigration);
			write_integer("./PlotBL-RESCE/totalChainLeave.txt",totalChainLeave);
			write_integer("./PlotBL-RESCE/listServerUsed.txt",listServerUsed);
			write_integer("./PlotBL-RESCE/requestRandom.txt",requestRandomReceive);
			write_integer("./PlotBL-RESCE/totalDecOffload.txt",totalDecOffload);
			write_integer("./PlotBL-RESCE/totalDenOffload.txt",totalDenOffload);
			write_double("./PlotBL-RESCE/totalPowerSystem.txt",totalPowerSystem);
			write_double("./PlotBL-RESCE/totalPowerSystemPerSFC.txt",totalPowerPerSFC);
			write_double("./PlotBL-RESCE/totalLoadEdge.txt",totalLoadEdge);
			write_double("./PlotBL-RESCE/totalBwEdge.txt",totalBwEdge);
			write_double("./PlotBL-RESCE/totalChainAcceptance.txt",totalChainAcceptance);
			write_integer("./PlotBL-RESCE/totalChainSystem.txt",totalChainSystem);
			write_integer("./PlotBL-RESCE/totalChainActive.txt",totalChainActive);
			write_integer("./PlotBL-RESCE/totalChainReject.txt",totalChainReject);
			write_excel("./PlotBL-RESCE/requestEachPiDetail.xlsx",listRequestForEachPi);
			write_excel("./PlotBL-RESCE/leaveEachPiDetail.xlsx",listLeaveForEachPi);
			write_excel("./PlotBL-RESCE/offSerEachPi01.xlsx",listOffForEachPi);
			write_excel_double("./PlotBL-RESCE/cpuEachPi01.xlsx",listCPUForEachPi);
			write_excel_double("./PlotBL-RESCE/bwEachPi01.xlsx",listBWForEachPi);
