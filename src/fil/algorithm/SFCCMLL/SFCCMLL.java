...
//			listVNFmigration.add(numVNFMigration);
		...
		try {
			write_double("./PlotSFCCM-LL/totalPiAcceptance.txt",totalPiAcceptance);
			write_double("./PlotSFCCM-LL/capacity.txt",capacity);
			write_double("./PlotSFCCM-LL/capacityEdge.txt",capacityEdge);
			write_double("./PlotSFCCM-LL/capacityCloud.txt",capacityCloud);
			write_double("./PlotSFCCM-LL/averageBWUsage.txt",averageBWUsage);
			write_double("./PlotSFCCM-LL/totalPowerSystemConsolidation.txt",totalPowerSystemConsolidation);
			write_double("./PlotSFCCM-LL/listLinkUsage.txt",listLinkUsage);
			write_double("./PlotSFCCM-LL/cpuEdgeUsagePerSFC.txt",cpuEdgeUsagePerSFC);
			write_double("./PlotSFCCM-LL/cpuServerUsagePerSFC.txt",cpuServerUsagePerSFC);
			write_double("./PlotSFCCM-LL/serverUtilization.txt",serverUtilization);
			write_integer("./PlotSFCCM-LL/NumVNFMigration.txt",listVNFmigration);
			write_integer("./PlotSFCCM-LL/totalChainLeave.txt",totalChainLeave);
			write_integer("./PlotSFCCM-LL/listServerUsed.txt",listServerUsed);
			write_integer("./PlotSFCCM-LL/requestRandom.txt",requestRandomReceive);
			write_integer("./PlotSFCCM-LL/totalDecOffload.txt",totalDecOffload);
			write_integer("./PlotSFCCM-LL/totalDenOffload.txt",totalDenOffload);
			write_double("./PlotSFCCM-LL/totalPowerSystem.txt",totalPowerSystem);
			write_double("./PlotSFCCM-LL/totalPowerSystemPerSFC.txt",totalPowerPerSFC);
			write_double("./PlotSFCCM-LL/totalLoadEdge.txt",totalLoadEdge);
			write_double("./PlotSFCCM-LL/totalBwEdge.txt",totalBwEdge);
			write_double("./PlotSFCCM-LL/totalChainAcceptance.txt",totalChainAcceptance);
			write_integer("./PlotSFCCM-LL/totalChainSystem.txt",totalChainSystem);
			write_integer("./PlotSFCCM-LL/totalChainActive.txt",totalChainActive);
			write_integer("./PlotSFCCM-LL/totalChainReject.txt",totalChainReject);
			write_excel("./PlotSFCCM-LL/requestEachPiDetail.xlsx",listRequestForEachPi);
			write_excel("./PlotSFCCM-LL/leaveEachPiDetail.xlsx",listLeaveForEachPi);
			write_excel("./PlotSFCCM-LL/offSerEachPi01.xlsx",listOffForEachPi);
			write_excel_double("./PlotSFCCM-LL/cpuEachPi01.xlsx",listCPUForEachPi);
			write_excel_double("./PlotSFCCM-LL/bwEachPi01.xlsx",listBWForEachPi);
