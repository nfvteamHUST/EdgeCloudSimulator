...
//			write_integer("./PlotRESCE-LL/numChainAcceptRESCE-LL.txt",numChainAccept);
			write_excel("./PlotRESCE-LL/requestEachPiDetail.xlsx",listRequestForEachPi);
			write_excel("./PlotRESCE-LL/leaveEachPiDetail.xlsx",listLeaveForEachPi);
			write_excel("./PlotRESCE-LL/offSerEachPi01.xlsx",listOffForEachPi);
			write_excel_double("./PlotRESCE-LL/cpuEachPi01.xlsx",listCPUForEachPi);
			write_excel_double("./PlotRESCE-LL/bwEachPi01.xlsx",listBWForEachPi);
		} catch (IOException e) {
