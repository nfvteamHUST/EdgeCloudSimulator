...
//			outputWriter.write(x[i]);
	...
	public void run(Map<Integer,HashMap<Integer,LinkedList<Double>>> listRequest, LinkedList<Integer> timeWindow){
		...
		try {
			write_double("./PlotBL-LL/totalPiAcceptance.txt",totalPiAcceptance);
			write_double("./PlotBL-LL/capacity.txt",capacity);
			write_double("./PlotBL-LL/capacityEdge.txt",capacityEdge);
			write_double("./PlotBL-LL/capacityCloud.txt",capacityCloud);
			write_double("./PlotBL-LL/averageBWUsage.txt",averageBWUsage);
			write_double("./PlotBL-LL/totalPowerSystemConsolidation.txt",totalPowerSystemConsolidation);
			write_double("./PlotBL-LL/listLinkUsage.txt",listLinkUsage);
			write_double("./PlotBL-LL/cpuEdgeUsagePerSFC.txt",cpuEdgeUsagePerSFC);
			write_double("./PlotBL-LL/cpuServerUsagePerSFC.txt",cpuServerUsagePerSFC);
			write_double("./PlotBL-LL/serverUtilization.txt",serverUtilization);
			write_integer("./PlotBL-LL/NumVNFMigration.txt",listVNFmigration);
			write_integer("./PlotBL-LL/totalChainLeave.txt",totalChainLeave);
			write_integer("./PlotBL-LL/listServerUsed.txt",listServerUsed);
			write_integer("./PlotBL-LL/requestRandom.txt",requestRandomReceive);
			write_integer("./PlotBL-LL/totalDecOffload.txt",totalDecOffload);
			write_integer("./PlotBL-LL/totalDenOffload.txt",totalDenOffload);
			write_double("./PlotBL-LL/totalPowerSystem.txt",totalPowerSystem);
			write_double("./PlotBL-LL/totalPowerSystemPerSFC.txt",totalPowerPerSFC);
			write_double("./PlotBL-LL/totalLoadEdge.txt",totalLoadEdge);
			write_double("./PlotBL-LL/totalBwEdge.txt",totalBwEdge);
			write_double("./PlotBL-LL/totalChainAcceptance.txt",totalChainAcceptance);
			write_integer("./PlotBL-LL/totalChainSystem.txt",totalChainSystem);
			write_integer("./PlotBL-LL/totalChainActive.txt",totalChainActive);
			write_integer("./PlotBL-LL/totalChainReject.txt",totalChainReject);
			write_excel("./PlotBL-LL/requestEachPiDetail.xlsx",listRequestForEachPi);
			write_excel("./PlotBL-LL/leaveEachPiDetail.xlsx",listLeaveForEachPi);
			write_excel("./PlotBL-LL/offSerEachPi01.xlsx",listOffForEachPi);
			write_excel_double("./PlotBL-LL/cpuEachPi01.xlsx",listCPUForEachPi);
			write_excel_double("./PlotBL-LL/bwEachPi01.xlsx",listBWForEachPi);
